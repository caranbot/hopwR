...
# Run selected lines              Ctrl + Return
# <-:                             Alt  + -
...
sample(die, 8)     # check arguments

args(sample)

sample(x = die, size = 8, replace = TRUE)
